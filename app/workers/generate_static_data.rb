...
class GenerateStaticData
  ...
  def perform file_names, units_of_measure

    units_of_measure.each do |unit|
      unit_of_measure = UnitOfMeasure.find_or_create_by code: unit.first, description: unit.last
    end
